...
from sklearn.model_selection import StratifiedKFold, GroupKFold, RepeatedKFold
...
def main():
    data = pd.read_csv (r'C:\Users\Vnixo\OneDrive\Desktop\userStoryML\storyPointEstimation\Data\TNE_2021-11-11-owner.csv')
    ...
    print(len(Y))
    smote = SMOTE(sampling_strategy='not majority', k_neighbors=10, n_jobs=-1)
    ...
    for i in range(100):
        ...
        if auc > best:
           #with open(fr'C:\Users\vnixon\Desktop\ML_models\userStoryAutomation\trained\tfidf-owner1.pickle', 'wb') as f:
           with open(fr'C:\Users\Vnixo\OneDrive\Desktop\userStoryML\storyPointEstimation\prod_models\model_owner1.pickle', 'wb') as f:
               dill.dump(rf, f)
           #dill.dump(transformer, open("tfidf_transformer_owner1.pkl","wb"))
           dill.dump(transformer, open(r"C:\Users\Vnixo\OneDrive\Desktop\userStoryML\storyPointEstimation\transformers\transformer_owner1.pickle","wb"))
           break
